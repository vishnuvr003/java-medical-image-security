<%-- 
    Document   : Home
    Created on : 20 Feb, 2018, 2:50:10 PM
    Author     : S7
--%>
...
<body class="body-bg" data-ana="PageView:pageView">
 ...
 <!-- MAIN WRAPPER -->
            ...
            <ul id="menu" class="collapse">
               ...
               <%-- <li class="panel active">
                 <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        <i class="icon-tasks"> </i>  Select Your Option
   ...
   <!-- FOOTER -->
    ...
    <script src="assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script></form>
</body>
